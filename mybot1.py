...
class Bot:
    ...
    def get_move(self, state):
		...
		If it's the opponents turn, check if you have the same suit as the opponent and play a
		random same suit card. Compare the moves with other moves and choose the card with the highest rank
